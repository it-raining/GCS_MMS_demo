...
class ScenarioResult:
    """Comparison result between CentroidRefineDMS and GCS-Bezier solvers."""
    scenario_name: str
    crd_result: OptimizationResult
    gcs_result: OptimizationResult
    crd_solve_time: float = 0.0
    gcs_solve_time: float = 0.0
    crd_cost: float = float("inf")
    gcs_cost: float = float("inf")
