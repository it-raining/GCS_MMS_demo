# GCS-DMS Optimization Report: `default_crd`
...
- **JSON summary:** `results/default_crd_summary.json`
- **PNG result:** `results/default_crd_result.png`
- **GIF animation:** `results/default_crd_animation.gif` *(if generated)*
